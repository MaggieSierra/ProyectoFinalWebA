...
<div class="contenedor">
	<img src="vistas/assets/img/logo_tec2.png">
	<div class="container-logo">
		<img id="img_login" src="vistas/assets/img/login.svg" width="100px">
		<h4 style="color:#00306d;">Sing In</h4>
		<form action="LoginServlet" method="post">
		  <table>
		    <tr>
		    	<td><img src="vistas/assets/img/usuario.svg" style="width:30px;"></td>
		    ...
		    <tr>
		    	<td><img src="vistas/assets/img/bloquear.svg" style="width:30px;"></td>
